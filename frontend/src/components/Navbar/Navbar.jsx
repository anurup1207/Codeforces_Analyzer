    ...
    <div className="navbar-container">
      <div className="nav">
        ...
        <div className="section my-5 ">
          <div className="mx-2">
            <img src="statistic 1.png" alt="" />
            <h5 className="my-4 mx-1 features">
              <Link
                to="/analysis"
        ...
        <div className="mx-2">
            <img src="exit 1.svg" alt="back button"  className="mx-2" style={{height:'32px', width:'32px'}}/>
            <h5 className="my-4 mx-3 features">
              <Link
                to="/"
                style={{ textDecoration: "none", color: "black" }}
              >
